...
#                      [44.5, -14.44, 1, 0], [44.5, -14.5, 2.5, 0],
#                      [28.6, -14.8, 2.5, -1.57], [28.7, -11.3, 2, -1.57],
#                      [40.0, -11.2, 4, -1.57], [40.1, -21.0, 4, -1.57]]
#block_put_position = [[44.5, -14.44, 1, 0], [34.4, -14.7, 1, 0]]
...
def inverse_kinematics(block_real_position, s):
    ...
    for key in block_real_position:
        ...
        grab_position = [grab_position[0][0]-4.5,grab_position[0][1],1]
...
def main():
    ...
    HOME_POSITION = [20,-15,20]
    roll = -math.pi/2
    traj = RPC.pipline_position_encoder_roll(HOME_POSITION, [30,-30,20], roll, s)
    traj = RPC.pipline_position_encoder_roll([30,-30,20], [30,-30,12], roll, s)
    Pipeline.C_execute([traj])
    '''
